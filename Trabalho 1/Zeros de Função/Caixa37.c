...
double f(double l) {
    //a funcao é a primeira derivada.
    return -2*(813/50.0-2*l)*l-2*(449/50.0-2*l)*l+(449/50.0-2*l)*(813/50.0-2*l);
}

double df(double l) {
    //nessa questao, use a segunda derivada.
    return (60000*l-252400)/2500.0;

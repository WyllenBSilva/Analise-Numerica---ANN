...
def g(t, i):
    ...
    '''''
Suponha que C=0.3734 farads, R=1.1809 ohm, L=1.5511 henrie e que a tensão seja dada por

E(t)=e−0.0764 πtsin(2t−π).
...
''''' 
    ...
    ##E(t)=e−0.0534 πtsin(2t−π).
    e_value = 0.0764 #OBS: VALOR POSITIVO
...
E(t)=e−0.0691πtsin(2t−π).
Se i(t0)=i0, com t0=0 e i0=0, use o método de Ralston para encontrar estimativas para a corrente i nos pontos tk=t0+kh, onde k=1,2,…,150 e h=0.1543.
'''
if __name__ == '__main__':

    #mudar h,n, C r e L em def g

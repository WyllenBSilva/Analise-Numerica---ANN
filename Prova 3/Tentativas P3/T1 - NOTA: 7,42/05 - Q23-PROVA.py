...
def g(t, i):
    ...
    '''''
Suponha que C=0.2655farads, R=1.2242 ohm, L=1.9037 henrie e que a tensão seja dada por
    ''''' 
    ...
    ##E(t)=e−0.0622 πtsin(2t−π).
    #E(t)=e−0.0543 πtsin(2t−π).
    e_value = 0.0543 #OBS: VALOR POSITIVO
